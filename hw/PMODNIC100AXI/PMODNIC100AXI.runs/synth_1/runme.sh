...
HD_PWD='/home/nyashabryan/VivadoProjects/PMODNIC100AXI/PMODNIC100AXI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PMODNIC100.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PMODNIC100.tcl
