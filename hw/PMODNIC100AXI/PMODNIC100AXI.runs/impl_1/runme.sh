...
HD_PWD='/home/nyashabryan/VivadoProjects/PMODNIC100AXI/PMODNIC100AXI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PMODNIC100.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PMODNIC100.tcl -notrace
